    ...
    <script>
        d3.json( "../data/1-json-durstexpress.json" )
            .then( ( file ) => {
                ...
                h.setAttribute("href", "../options/view__margin__top.html#example-a")
                h.innerText = "BACK"
                document.body.append(h)
            } )
    </script>
    <div style="display:none;">Set top margin to: ```0```</div>
</body>
```
## Example B.
    ...
    <script>
        d3.json( "../data/1-json-durstexpress.json" )
            .then( ( file ) => {
                ...
                h = document.createElement("a")
                h.setAttribute("href", "../options/view__margin__top.html#example-b")
                h.innerText = "BACK"
                document.body.append(h)
            } )
    </script>
    <div style="display:none;">Set top margin to: ```150```</div>
</body>
```
